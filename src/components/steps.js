...
Steps.defaultProps = {
  step3Description:
    'Our system will analyze the signs in the video and provide a translated version.',
  step2Description:
    'Choose the sign language you want to translate the video into.',
  step2Title: 'Select Language',
  step1Description:
    'Upload the video of the sign language you want to translate.',
  step1Title: 'Upload Sign Language Video',
  step4Title: 'Download Translated Video',
  step3Title: 'Translate Signs',
  step4Description:
    'Download the translated video with sign language interpretation.',
}
